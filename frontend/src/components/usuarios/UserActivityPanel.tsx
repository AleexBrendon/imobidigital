import { ArrowRight, LogIn, MoreHorizontal } from "lucide-react";

const activities = [
  { text: "Log-in por Maria Souza", icon: LogIn, color: "bg-indigo-500/30 text-indigo-300" },
  { text: "Log-ins por Maria Souza", icon: LogIn, color: "bg-emerald-500/30 text-emerald-300" },
  { text: "Managos de validio: Dr. Maria Souza", icon: ArrowRight, color: "bg-violet-500/30 text-violet-300" },
];
          ...
          return (
            <div key={index} className="flex gap-4">
              <div className="flex flex-col items-center">
                ...
                {index !== activities.length - 1 && <div className="mt-2 h-8 w-px bg-white/10" />}
              </div>
